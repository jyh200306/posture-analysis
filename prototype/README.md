...
PRD의 점수 공식으로 촬영 방향에 맞는 항목을 채점해 골격 오버레이와 피드백을 보여준다.

- **정면 사진**: 어깨 수평 · 골반 수평 · 목 정렬 (좌우 균형)
- **측면 사진**: 목(거북목) · 등 굽음 · 허리 정렬 · 척추 굽음 (앞뒤 굽은 정도)
...
- 측면의 척추 굽음은 귀–어깨–골반 세 점이 꺾인 각도로 근사 (관절 사이 실제 굴곡은 미측정)
- 촬영 방향은 사용자가 직접 선택 (자동 감지는 추후 검토)
